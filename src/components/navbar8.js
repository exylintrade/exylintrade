  ...
  return (
    <header className="navbar8-container1">
      <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
        <img alt="Exylin Trade Logo" src={logo} className="navbar8-image1" />
        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <Link
              to="/contact"
              className="navbar8-link thq-link thq-body-small"
            >
                            ...
                            {props.page1Description ?? (
                              <Fragment>
                                <span className="navbar8-text22">
                                  Welcome to Exylin Trade - Your Import and
                                  Export Partner
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text26">
                                  Explore the range of services we offer in
                                  electronics, machinery, textiles, and raw
                                  materials
                                </span>
                              </Fragment>
                            )}
                            ...
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text14">
                                  Get in touch with us for your import and
                                  export needs
                                </span>
                              </Fragment>
                            )}
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span className="thq-body-small">
                      {props.page1Description ?? (
                        <Fragment>
                          <span className="navbar8-text22">
                            Welcome to Exylin Trade - Your Import and Export
                            Partner
                          </span>
                        </Fragment>
                      )}
                  ...
                  <div className="navbar8-content8">
                    ...
                    <span className="thq-body-small">
                      {props.page4Description ?? (
                        <Fragment>
                          <span className="navbar8-text14">
                            Get in touch with us for your import and export
                            needs
                          </span>
                        </Fragment>
                      )}
...
Navbar8.defaultProps = {
  linkUrlPage1: "/", // ✅ correct
  link2Url: "/about", // ✅ correct
  linkUrlPage2: "/about", // ✅ correct
  link3Url: "/services", // ✅ correct
  linkUrlPage3: "/services", // ✅ correct
  linkUrlPage4: "/contact", // ✅ correct
};
